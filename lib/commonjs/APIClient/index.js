...
const Emitter = new _reactNative.NativeEventEmitter(NativeAPIClient);
const {
  EVENTS
...
class APIClient {
  constructor(baseUrl) {
    ...
    (0, _schemas.validateAPIClientConfiguration)(config);
  }
  ...
  upload = (endpoint, fileUrl, options) => {
    (0, _schemas.validateUploadRequestOptions)(options);
...
const isValidBaseURL = baseUrl => {
  return (0, _isURL.default)(baseUrl, {
